...
require('farbtastic');
require('wickedmenu/wicked-ui.css');
require('wickedmenu/wicked-ui.js');
require('tipsy');
...
$(document).ready(function() {
	...
	var ed = $('#mergely');
	if (!ed.mergely) {
		console.error('mergely is undefined');
		document.write('<pre>mergely is undefined</pre>');
		return;
	}
	var menu = $('#main-menu');
	var toolbar = $('#toolbar');
	...
	var iconconf = {
		...
		'options-sidebars': {
			get: function() { return ed.mergely('options').sidebar },
			set: function(value) {
		...
		'options-viewport': {
			get: function() { return ed.mergely('options').viewport },
			set: function(value) {
		...
		'options-linenumbers': {
			get: function() { return ed.mergely('options').line_numbers },
			set: function(value) {
		...
		'options-wrap': {
			get: function() { return ed.mergely('options').wrap_lines },
			set: function(value) {
